...
export const metadata: Metadata = seo({ title: 'Black Hills Visitor Guide — Things to Do & Itineraries', description: 'Complete guide to the Black Hills. 6-day itinerary, top attractions, Deadwood, Spearfish Canyon & more.', path: '/black-hills' });

export default function Page() {
  return (
    <>
      <Breadcrumbs items={[{ label: 'Black Hills Guide' }]} />
      <section className="relative py-20 md:py-28 bg-brand-navy text-white overflow-hidden">
        <div className="absolute inset-0 animate-shimmer" />
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          <h1 className="mb-6">Black Hills Visitor Guide — Things to Do & Itineraries</h1>
          <p className="text-lg text-white/70 max-w-3xl mx-auto">Complete guide to the Black Hills. 6-day itinerary, top attractions, Deadwood, Spearfish Canyon & more.</p>
          <div className="mt-8">
      ...
      <section className="section-pad bg-surface-primary">
        <div className="max-w-4xl mx-auto px-4">
          <p className="text-lg text-brand-navy/80 mb-8">Complete guide to the Black Hills. 6-day itinerary, top attractions, Deadwood, Spearfish Canyon & more.</p>
