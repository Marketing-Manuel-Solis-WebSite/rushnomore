...
export const metadata: Metadata = seo({ title: 'Black Hills Itineraries — 1 to 7 Day Plans', description: 'Curated day-by-day itineraries for the Black Hills and Mount Rushmore area from Rush No More.', path: '/itineraries' });
    ...
    <>
      ...
      <section className="relative py-20 md:py-28 bg-brand-navy text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          <h1 className="mb-6">Black Hills Itineraries — 1 to 7 Day Plans</h1>
          <p className="text-lg text-white/70 max-w-3xl mx-auto">Curated day-by-day itineraries for the Black Hills and Mount Rushmore area from Rush No More.</p>
          <div className="mt-8">
      ...
      <section className="section-pad bg-surface-primary">
        <div className="max-w-4xl mx-auto px-4">
          <p className="text-lg text-brand-navy/80 mb-8">Curated day-by-day itineraries for the Black Hills and Mount Rushmore area from Rush No More.</p>
