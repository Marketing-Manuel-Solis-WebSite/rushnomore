...
export const metadata: Metadata = seo({
  ...
  description: 'Book your 2026 Sturgis Motorcycle Rally stay (Aug 2–18) at Rush No More. Rally RV sites from $899/10 days, cabins & tent sites 5 miles from Main Street Sturgis. Beer garden, pool, hot tubs. 10+ years as rally HQ — book early, we sell out.',
