...
export const metadata: Metadata = seo({ title: 'Mount Rushmore Camping & RV Park — Visitor Guide', description: 'Everything about visiting Mount Rushmore. Stay at Rush No More — 55 miles away with RV sites, cabins & camping.', path: '/mount-rushmore' });

export default function Page() {
  return (
    <>
      <Breadcrumbs items={[{ label: 'Mount Rushmore Guide' }]} />
      <section className="relative py-20 md:py-28 bg-brand-navy text-white overflow-hidden">
        <div className="absolute inset-0 animate-shimmer" />
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          <h1 className="mb-6">Mount Rushmore Camping & RV Park — Visitor Guide</h1>
          <p className="text-lg text-white/70 max-w-3xl mx-auto">Everything about visiting Mount Rushmore. Stay at Rush No More — 55 miles away with RV sites, cabins & camping.</p>
          <div className="mt-8">
      ...
      <section className="section-pad bg-surface-primary">
        <div className="max-w-4xl mx-auto px-4">
          <p className="text-lg text-brand-navy/80 mb-8">Everything about visiting Mount Rushmore. Stay at Rush No More — 55 miles away with RV sites, cabins & camping.</p>
