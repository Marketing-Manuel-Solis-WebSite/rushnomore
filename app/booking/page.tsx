...
const TYPES = [
  { id: 'cabin' as PropertyType, label: 'Cabins', icon: Home, price: 'Starts at $51.76/night', desc: '20 Presidential Cabins, 2-10 guests', img: '/images/Cabins/CabinJamesMonroe/PhotoMainJamesMonroe.jpeg' },
