...
export const metadata: Metadata = seo({ title: 'Custer State Park — Buffalo Herds, Needles Highway & Hiking', description: '71,000 acres of wildlife, scenic drives & Needles Eye. 70 miles from Rush No More.', path: '/attractions/custer-state-park' });

export default function Page() {
  return (
    <>
      <Breadcrumbs items={[{ label: 'Custer State Park' }]} />
      <section className="relative py-20 md:py-28 bg-brand-navy text-white overflow-hidden">
        <div className="absolute inset-0 animate-shimmer" />
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          <h1 className="mb-6">Custer State Park — Buffalo Herds, Needles Highway & Hiking</h1>
          <p className="text-lg text-white/70 max-w-3xl mx-auto">71,000 acres of wildlife, scenic drives & Needles Eye. 70 miles from Rush No More.</p>
          <div className="mt-8">
      ...
      <section className="section-pad bg-surface-primary">
        <div className="max-w-4xl mx-auto px-4">
          <p className="text-lg text-brand-navy/80 mb-8">71,000 acres of wildlife, scenic drives & Needles Eye. 70 miles from Rush No More.</p>
