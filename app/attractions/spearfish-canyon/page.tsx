...
export const metadata: Metadata = seo({ title: 'Spearfish Canyon — Scenic Drives, Waterfalls & Fly Fishing', description: 'Bridal Veil Falls, Roughlock Falls, fly fishing. 25 miles from Rush No More.', path: '/attractions/spearfish-canyon' });

export default function Page() {
  return (
    <>
      <Breadcrumbs items={[{ label: 'Spearfish Canyon' }]} />
      <section className="relative py-20 md:py-28 bg-brand-navy text-white overflow-hidden">
        <div className="absolute inset-0 animate-shimmer" />
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          <h1 className="mb-6">Spearfish Canyon — Scenic Drives, Waterfalls & Fly Fishing</h1>
          <p className="text-lg text-white/70 max-w-3xl mx-auto">Bridal Veil Falls, Roughlock Falls, fly fishing. 25 miles from Rush No More.</p>
          <div className="mt-8">
      ...
      <section className="section-pad bg-surface-primary">
        <div className="max-w-4xl mx-auto px-4">
          <p className="text-lg text-brand-navy/80 mb-8">Bridal Veil Falls, Roughlock Falls, fly fishing. 25 miles from Rush No More.</p>
