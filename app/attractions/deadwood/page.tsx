...
export const metadata: Metadata = seo({ title: 'Deadwood SD Guide — Gambling, Museums & Gold Panning', description: 'Historic Deadwood: 80+ gaming halls, Adams Museum, Homestake Gold Mine. 12 miles from Rush No More.', path: '/attractions/deadwood' });

export default function Page() {
  return (
    <>
      <Breadcrumbs items={[{ label: 'Deadwood' }]} />
      <section className="relative py-20 md:py-28 bg-brand-navy text-white overflow-hidden">
        <div className="absolute inset-0 animate-shimmer" />
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          <h1 className="mb-6">Deadwood SD Guide — Gambling, Museums & Gold Panning</h1>
          <p className="text-lg text-white/70 max-w-3xl mx-auto">Historic Deadwood: 80+ gaming halls, Adams Museum, Homestake Gold Mine. 12 miles from Rush No More.</p>
          <div className="mt-8">
      ...
      <section className="section-pad bg-surface-primary">
        <div className="max-w-4xl mx-auto px-4">
          <p className="text-lg text-brand-navy/80 mb-8">Historic Deadwood: 80+ gaming halls, Adams Museum, Homestake Gold Mine. 12 miles from Rush No More.</p>
