...
export const metadata: Metadata = seo({ title: 'Weddings, Reunions & Group Events', description: 'Beautiful outdoor pavilion with kitchen, events center for weddings, parties & corporate retreats.', path: '/events/weddings' });
    ...
    <>
      ...
      <section className="relative py-20 md:py-28 bg-brand-navy text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-white/70 max-w-3xl mx-auto">Beautiful outdoor pavilion with kitchen, events center for weddings, parties & corporate retreats.</p>
          <div className="mt-8">
