...
export const metadata: Metadata = seo({ title: 'Sturgis Motorcycle Rally — Your Perfect Base Camp', description: 'Rush No More: rally HQ for 10+ years. 5 miles from Main St Sturgis. RV, tent & cabin options.', path: '/events/sturgis-rally' });
